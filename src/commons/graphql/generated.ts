...
export type Morph = EmailAuth | EmailAuthAggregator | EmailAuthConnection | EmailAuthConnectionCode | EmailAuthConnectionCreated_At | EmailAuthConnectionEmail | EmailAuthConnectionId | EmailAuthConnectionIsAuth | EmailAuthConnectionType | EmailAuthConnectionUpdated_At | EmailAuthGroupBy | Finbig | FinbigAggregator | FinbigAggregatorAvg | FinbigAggregatorMax | FinbigAggregatorMin | FinbigAggregatorSum | FinbigConnection | FinbigConnectionApiName | FinbigConnectionCategory | FinbigConnectionContents | FinbigConnectionCreated_At | FinbigConnectionDescription | FinbigConnectionId | FinbigConnectionIsBest | FinbigConnectionIsShow | FinbigConnectionOrder | FinbigConnectionPeriod | FinbigConnectionPublished_At | FinbigConnectionThumbnail | FinbigConnectionTitle | FinbigConnectionType | FinbigConnectionUpdated_At | FinbigConnectionUser | FinbigConnectionViewCount | FinbigGroupBy | I18NLocale | SubscriptionHistory | SubscriptionHistoryAggregator | SubscriptionHistoryAggregatorAvg | SubscriptionHistoryAggregatorMax | SubscriptionHistoryAggregatorMin | SubscriptionHistoryAggregatorSum | SubscriptionHistoryConnection | SubscriptionHistoryConnectionCreated_At | SubscriptionHistoryConnectionId | SubscriptionHistoryConnectionMid | SubscriptionHistoryConnectionPaymentMethod | SubscriptionHistoryConnectionPaymentStatus | SubscriptionHistoryConnectionPeriod | SubscriptionHistoryConnectionPrice | SubscriptionHistoryConnectionPublished_At | SubscriptionHistoryConnectionTitle | SubscriptionHistoryConnectionUpdated_At | SubscriptionHistoryConnectionUser | SubscriptionHistoryGroupBy | Token | TokenAggregator | TokenConnection | TokenConnectionCreated_At | TokenConnectionId | TokenConnectionPublished_At | TokenConnectionToken | TokenConnectionUpdated_At | TokenConnectionUserId | TokenGroupBy | UploadFile | UploadFileAggregator | UploadFileAggregatorAvg | UploadFileAggregatorMax | UploadFileAggregatorMin | UploadFileAggregatorSum | UploadFileConnection | UploadFileConnectionAlternativeText | UploadFileConnectionCaption | UploadFileConnectionCreated_At | UploadFileConnectionExt | UploadFileConnectionFormats | UploadFileConnectionHash | UploadFileConnectionHeight | UploadFileConnectionId | UploadFileConnectionMime | UploadFileConnectionName | UploadFileConnectionPreviewUrl | UploadFileConnectionProvider | UploadFileConnectionProvider_Metadata | UploadFileConnectionSize | UploadFileConnectionUpdated_At | UploadFileConnectionUrl | UploadFileConnectionWidth | UploadFileGroupBy | UserPermissionsPasswordPayload | UsersPermissionsLoginPayload | UsersPermissionsMe | UsersPermissionsMeRole | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsRoleAggregator | UsersPermissionsRoleConnection | UsersPermissionsRoleConnectionDescription | UsersPermissionsRoleConnectionId | UsersPermissionsRoleConnectionName | UsersPermissionsRoleConnectionType | UsersPermissionsRoleGroupBy | UsersPermissionsUser | UsersPermissionsUserAggregator | UsersPermissionsUserAggregatorAvg | UsersPermissionsUserAggregatorMax | UsersPermissionsUserAggregatorMin | UsersPermissionsUserAggregatorSum | UsersPermissionsUserConnection | UsersPermissionsUserConnectionBlocked | UsersPermissionsUserConnectionConfirmed | UsersPermissionsUserConnectionCreated_At | UsersPermissionsUserConnectionDeletedAt | UsersPermissionsUserConnectionDownloadCount | UsersPermissionsUserConnectionEmail | UsersPermissionsUserConnectionEmailReception | UsersPermissionsUserConnectionExpirationDate | UsersPermissionsUserConnectionId | UsersPermissionsUserConnectionIsAdmin | UsersPermissionsUserConnectionIsDeleted | UsersPermissionsUserConnectionIsSubscribe | UsersPermissionsUserConnectionName | UsersPermissionsUserConnectionPhone | UsersPermissionsUserConnectionProvider | UsersPermissionsUserConnectionRole | UsersPermissionsUserConnectionSmsReception | UsersPermissionsUserConnectionSubscriptionDate | UsersPermissionsUserConnectionUpdated_At | UsersPermissionsUserConnectionUsername | UsersPermissionsUserGroupBy | VisualData | VisualDataAggregator | VisualDataConnection | VisualDataConnectionCategory | VisualDataConnectionContents | VisualDataConnectionCreated_At | VisualDataConnectionDescription | VisualDataConnectionId | VisualDataConnectionIsShow | VisualDataConnectionPublished_At | VisualDataConnectionThumbnail | VisualDataConnectionTitle | VisualDataConnectionUpdated_At | VisualDataConnectionViewCount | VisualDataGroupBy | CreateEmailAuthPayload | CreateFinbigPayload | CreateRolePayload | CreateSubscriptionHistoryPayload | CreateTokenPayload | CreateUserPayload | CreateVisualDatumPayload | DeleteEmailAuthPayload | DeleteFilePayload | DeleteFinbigPayload | DeleteRolePayload | DeleteSubscriptionHistoryPayload | DeleteTokenPayload | DeleteUserPayload | DeleteVisualDatumPayload | UpdateEmailAuthPayload | UpdateFinbigPayload | UpdateRolePayload | UpdateSubscriptionHistoryPayload | UpdateTokenPayload | UpdateUserPayload | UpdateVisualDatumPayload;
...
export type SubscriptionHistoryGroupBy = {
  ...
  paymentMethod?: Maybe<Array<Maybe<SubscriptionHistoryConnectionPaymentMethod>>>;
  paymentStatus?: Maybe<Array<Maybe<SubscriptionHistoryConnectionPaymentStatus>>>;
...
export type UsersPermissionsUserGroupBy = {
  ...
  downloadCount?: Maybe<Array<Maybe<UsersPermissionsUserConnectionDownloadCount>>>;
  email?: Maybe<Array<Maybe<UsersPermissionsUserConnectionEmail>>>;
  emailReception?: Maybe<Array<Maybe<UsersPermissionsUserConnectionEmailReception>>>;
  expirationDate?: Maybe<Array<Maybe<UsersPermissionsUserConnectionExpirationDate>>>;
  ...
  subscriptionDate?: Maybe<Array<Maybe<UsersPermissionsUserConnectionSubscriptionDate>>>;
